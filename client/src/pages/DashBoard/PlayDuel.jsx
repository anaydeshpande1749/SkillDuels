        ...
        >
          {quizDomains.map((domain) => (
            <motion.div
              ...
              onClick={() => handleSelectCategory(domain)}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-[#1f5cff] to-[#00bcd4] opacity-25 blur-2xl group-hover:opacity-40 transition" />
...
//     axios.get("http://localhost:9000/api/game/categories")
...
//     axios.get(
//       `http://localhost:9000/api/game/quiz/${encodeURIComponent(category)}`
//     )
//     .then(res => {
